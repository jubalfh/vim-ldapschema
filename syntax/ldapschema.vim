...
syntax region LDAPSchemaAttrType start="attributetype\_s\+(" end=")" contains=LDAPSchemaKeyAttrType,@LDAPSchemaStd,@LDAPSchemaAttr
syntax keyword LDAPSchemaKeyAttrType attributetype contained

syntax region LDAPSchemaObjClass start="objectclass\_s\+(" end=")" contains=LDAPSchemaKeyObjClass,@LDAPSchemaStd,@LDAPSchemaObj
